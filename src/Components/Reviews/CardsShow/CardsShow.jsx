...
import CardShow from "../Card/CardShow.jsx";
...
export default function CardsShow() {
  ...
  const settings = {
    ...
    appendDots: (dots) => (
      <div>
        {" "}
        <ul className="uuu" style={{ margin: "0px" }}>
          {" "}
          {dots.filter((_, idx) => idx % 2 === 0)}{" "}
        </ul>{" "}
      </div>
    ),
  };
