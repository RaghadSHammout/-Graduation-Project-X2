...
//          </div>
        ...
        <div className='Subscription'>
            ...
            <a href="/" className='links'>Plans</a>
        ...
        <div className='contecticonfooter'>
            ...
            <div className='contericon-zq'><a href="/" className='links'><img src={FaFacebook} alt="" /></a></div>
            <div className='contericon-zq'><a href="/" className='links'><img src={twittericon} alt="" /></a></div>
            <div className='contericon-zq'><a href="/" className='links'><img src={linkedinicon} alt="" /></a></div>
            </div>
        </div>
        </div>
